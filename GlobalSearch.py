...
class GlobalSearch(Search):
    ...
    def trainGlobal(self, database, uncovered_objectives) -> "TODO":
    ...
    def update(self, best_tc, most_uncertain_tc, test_cases, uncovered_objectives, error_thresholds) -> (set[TestCase],set[TestCase],"TODO"):
